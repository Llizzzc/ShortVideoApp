...
/**
 * 针对mongodb的service层接口实现类.
 *
 * @author lzc
 * @version 1.0
 */
@Service
public class MsgServiceImpl extends BasePropertiesInfo implements MsgService {
    ...
    public void createMsg(String fromUserId, String toUserId, Integer type, Map msgContent) {
        ...
        Users fromUser = usersService.getUser(fromUserId);
    ...
    public List<MessageMO> queryList(String toUserId, Integer page, Integer pageSize) {
        ...
        for (MessageMO msg : list) {
            ...
            if (msg.getMsgType() != null && msg.getMsgType() == MessageTypeEnum.FOLLOW_YOU.type) {
